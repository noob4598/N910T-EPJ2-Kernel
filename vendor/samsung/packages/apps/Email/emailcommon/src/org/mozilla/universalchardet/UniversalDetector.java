...
public class UniversalDetector {
    ...
    private String detectedAllCharset;
    ...
    // //////////////////////////////////////////////////////////////
    /**
     * @param listener a listener object that is notified of the detected
     *            encocoding. Can be null.
     */
    ...
    public String getDetectedAllCharset() {
        return this.detectedAllCharset;
    }
    ...
    public String getDetectedCharset() {
        if (this.detectedCharset == null)
            return null;
        return this.detectedCharset.split(" ")[0];
    }
    ...
    public void dataEnd() {
        ...
        if (this.detectedCharset != null) {
            ...
            this.detectedAllCharset = this.detectedCharset;//
            return;
        }
        ...
        if (this.inputState == InputState.HIGHBYTE) {
            ...
            for (int i = 0; i < this.probers.length; ++i) {
                ...
                if (proberConfidence > MINIMUM_THRESHOLD) {
                    if (this.detectedAllCharset == null)
                        this.detectedAllCharset = this.probers[i].getCharSetName();//
                    else
                        this.detectedAllCharset = this.detectedAllCharset.concat(" "
                                + this.probers[i].getCharSetName());//
                }
            }
