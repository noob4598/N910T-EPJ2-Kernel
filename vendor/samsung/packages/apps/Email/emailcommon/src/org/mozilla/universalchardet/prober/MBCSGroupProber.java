...
public class MBCSGroupProber extends CharsetProber {
    ...
    public String getCharSetName() {
        ...
        String result = this.probers[this.bestGuess].getCharSetName();
        if (this.bestGuess2 != -1) {
            result = result.concat(" " + this.probers[this.bestGuess2].getCharSetName());
        }
        return result;
    }
        ...
        if (this.state == ProbingState.FOUND_IT) {
            ...
            for (int i = 0; i < probers.length; ++i) {
                ...
                if (bestConf < cf) {
                    bestConf = cf;
                    this.bestGuess = i;
                } else if (bestConf == cf) {// just second..
                    this.bestGuess2 = i;
                }
            }
        }
